    ...
    <section className="grid w-full p-6 backdrop-blur-md bg-lightDark/90 dark:bg-darkDark/90 text-darkDark dark:text-lightLight rounded shadow-md  border-darkLight dark:border-lightDark">
      ...
      <div className="grid grid-cols-[min-content_1fr] gap-4">
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center text-darkLight dark:text-lightDark border border-darkLight dark:border-lightDark rounded-full font-bold transition hover:text-white dark:hover:text-white hover:bg-darkLight dark:hover:bg-lightDark"
          aria-label="Close"
        >
          ✕
        </button>
