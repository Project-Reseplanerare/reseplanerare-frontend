...
const GeneralInformation: React.FC = () => {
  ...
  return (
    <section className="grid w-full p-6 bg-lightDark dark:bg-darkDark text-darkDark dark:text-lightLight border rounded border-lightBorder dark:border-lightDark  ">
