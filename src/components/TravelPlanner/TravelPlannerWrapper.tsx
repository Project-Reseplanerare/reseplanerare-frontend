...
const TravelPlannerWrapper = () => {
  ...
  return (
    <section className="grid w-full p-8 shadow-md rounded border-darkLight dark:border-lightDark  bg-lightDark dark:bg-darkDark text-darkDark dark:text-lightLight">
      {/* Title Section */}
